...
class AnimationController {
  ...
  public rotate(v1: Vector2D, v2: Vector2D, p: number, orientation: boolean): Vector2D {
    ...
    return new Vector2D(
      middle.x + radius * (1 + bounce) * Math.cos(angle + orientationMultiplier * Math.PI * elastic),
      middle.y + radius * (1 + bounce) * Math.sin(angle + orientationMultiplier * Math.PI * elastic),
    )
  }
